...
const SortingFilteringState: React.FC<SortingFilteringBoxProps> = ({ requestSort }) => {
  ...
  return (
    <div className=" relative " ref={sortingFilteringRef}>
      ...
      {isOpen && (
        <div className=" absolute flex mt-2 bg-white border border-gray-300 shadow-lg rounded-lg p-4 ">
         {/* <div className="  mb-4">
          ...
          <div className="mt-4">
            <h2 className="mt-2 ml-4 font-worksans text-14 font-bold text-black">
              Seleccionar Estado
            </h2>
            <div className="flex flex-col ml-4 font-roboto text-16 text-gray8">
